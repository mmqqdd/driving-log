...
网站三栏：**科目一**、**模拟考试**、**考试记录**。科目一按「一章一课 + 一包题」长。科二科三以后套同一套架子。
...
考试记录只记日常（报名、听课、约考）。流程页留在记录里，不和课程抢位置。科二科三页面先不上导航。
...
- **练**：题包至少 12 道，上场抽 5 道，再练不容易撞车
- **过**：抽一组全对，或自己点下一节。先不做账号和进度存档
- **长**：先加题，再拆节。一页超过两屏，就把一块拆出去

整本 100 题模拟仍去东方时尚 / 12123。这个站负责：**规则学会、易混题练熟**。
